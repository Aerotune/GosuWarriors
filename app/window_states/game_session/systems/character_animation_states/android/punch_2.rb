Systems::CharacterAnimationStates.create_class __FILE__ do
  def on_set entity, time
    ...
    motion_state.tween game_session, entity, time+5,
    'distance' => (35<<10)*drawable.factor_x,
    'duration' => 15,
    'push_beyond_ledge' => false
  end
  ...
  def update entity, time
    ...
    if character.queued_animation_state == 'punch_3' && (12..15) === sprite.index
